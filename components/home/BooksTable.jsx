                ...
                <tbody>
{
    books.map((book,index)=>(
        <tr key={book._id} className='h-8'>
            ...
            <td className='border border-gray-700 rounded-md text-center max-md:hidden'>{book.author}</td>
            <td className='border border-gray-700 rounded-md text-center max-md:hidden'>{book.publishYear}</td>
